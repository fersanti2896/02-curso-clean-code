...
Viene de las siglas _Don't Repeat Yourself_ el cual tiene como principios: 

- Evitar tener la duplicidad de código. 
- Simplificar las pruebas.
- Ayuda a centralizar procesos.


Aplicando el principio DRY lleva usualmente hacer una refactorización. 
